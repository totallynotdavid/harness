...
Run coding agents across multiple projects from one place.

## Read next

- [Getting started](docs/getting-started.md) explains registration and the first task.
- [Commands](docs/commands.md) groups the CLI by job.

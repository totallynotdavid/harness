...
| `cap doctor [--diff REPORT]` / `cap doctor --remote HOST [--path CAP_HOME]` | Register this checkout as `~/.local/bin/cap`, describe the host, or compare it with a host discovered over SSH. |
